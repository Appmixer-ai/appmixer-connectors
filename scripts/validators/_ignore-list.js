...
module.exports = [
    ...
    {
        validator: 'no-select-with-source',
        messageIncludes: 'is type "select" with a dynamic source',
        paths: [
