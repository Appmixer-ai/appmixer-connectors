...
const { sendArrayOutput } = require('../../src/appmixer/azuredocumentintelligence/lib');
...
describe('azuredocumentintelligence lib', () => {
    ...
    describe('sendArrayOutput', () => {
        ...
        it('should deliver array output to the out port', async () => {
            ...
            assert.deepStrictEqual(jsonCalls[0].payload, { result: sampleRecords }, 'should format array payload correctly');
        });
