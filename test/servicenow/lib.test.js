...
const { sendArrayOutput } = require('../../src/appmixer/servicenow/lib');
...
describe('servicenow lib', () => {
    ...
    describe('sendArrayOutput', () => {
        ...
        it('should deliver array output to the out port', async () => {
            ...
            assert.deepStrictEqual(jsonCalls[0].payload, { items: sampleRecords }, 'should format array payload correctly');
        });
