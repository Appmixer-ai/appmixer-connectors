...
const { sendArrayOutput } = require('../../src/appmixer/googleBlogger/lib.generated');
...
describe('googleBlogger lib', () => {
    ...
    describe('sendArrayOutput', () => {
        ...
        it('should deliver array output to the out port', async () => {
            ...
            assert.deepStrictEqual(jsonCalls[0].payload, sampleRecords, 'should format array payload correctly');
        });
