...
describe('ListTeams Component', function() {
    ...
    beforeEach(function() {
        ...
        component = require('../../../src/appmixer/front/team/ListTeams/ListTeams.js');
    });
    ...
    it('should make GET request to correct URL', async function() {
        ...
        assert(requestConfig.url === 'https://api2.frontapp.com/teams', 'Should use correct URL');
    ...
    it('should handle empty team list', async function() {
        const mockResponse = [];
        ...
        assert.deepEqual(outputData, [], 'Should send empty array for no teams');
        assert(outputPort === 'out', 'Should send to out port');
    });
});
