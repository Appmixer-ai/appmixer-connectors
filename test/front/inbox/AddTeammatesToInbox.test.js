...
describe('AddTeammatesToInbox Component', function() {

    let component;

    beforeEach(function() {
        component = require('../../../src/appmixer/front/inbox/AddTeammatesToInbox/AddTeammatesToInbox.js');
    });
    ...
    it('should send response to out port', async function() {
        ...
        assert.deepEqual(outputData.teammates, ['tea_123', 'tea_456'], 'Should include teammate IDs');
