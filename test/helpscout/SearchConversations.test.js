...
describe('SearchConversations', () => {
    ...
    const componentPath = '../../src/appmixer/helpscout/core/SearchConversations/SearchConversations.js';
    let component;
    ...
    it('should search conversations with query', async () => {
        ...
        const context = {
            ...
            sendJson: (data, port) => {
                ...
                console.log(`Found ${data.count} conversations matching "test"`);
    ...
    it('should throw error when query is missing', async () => {
        ...
        try {
            await component.receive(context);
            assert.fail('Should have thrown an error for missing query');
        } catch (error) {
            assert(error.message.includes('Search query is required'));
        }
    });
