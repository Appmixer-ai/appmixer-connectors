...
module.exports = {
    ...
    async receive(context) {
        ...
        // Build the user data for the operation
        const userData = { userIdentifiers };

        // Consent is recommended for 'create' operations (required from API v15+)
        if (operation === 'create' && (adUserDataConsent || adPersonalizationConsent)) {
            userData.consent = {};
