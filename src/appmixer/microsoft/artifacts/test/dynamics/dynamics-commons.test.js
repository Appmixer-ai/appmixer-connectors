...
const commons = require('../../../dynamics/dynamics-commons');
...
describe('dynamics-commons', () => {
    ...
    describe('getOutputPortOptions', () => {
        ...
        beforeEach(function() {
            ...
            context.resource = 'https://orgFooBar.crm4.dynamics.com';
    ...
    describe('generateInspector', () => {
        ...
        describe('update', () => {
            ...
            it('should have ID field and not objectName field', async function() {
                ...
                // Add this line to provide objectName fallback for the implementation:
                context.messages.in.content.objectName = 'lead';
