...
describe('Slack Tasks interactions - AuthHub forwarding to tenant', () => {
    ...
    beforeEach(async () => {
        ...
        const memory = { tasks: {} };
        const taskModelPath = require.resolve('../../../tasks/SlackTaskModel.js');
        ...
        const utilsPath = require.resolve('../../../tasks/utils.js');
    ...
    afterEach(() => {
        ...
        try { delete require.cache[require.resolve('../../../tasks/SlackTaskModel.js')]; } catch (_) {}
        try { delete require.cache[require.resolve('../../../tasks/utils.js')]; } catch (_) {}
    });
    ...
    it('forwards Approve to tenant and tenant triggers webhook (end-to-end)', async () => {
        ...
        const Task = require('../../../tasks/SlackTaskModel.js')(tenantContext);
